...
//            );
    ...
    void chooseFile(ActionEvent event) throws FileNotFoundException {
        ...
        fc.getExtensionFilters().add(new FileChooser.ExtensionFilter("Word File", selectedFile));
...
//        try{
//            BufferedReader reader = new BufferedReader( new FileReader( new File(f.getAbsolutePath()) ) );
//            String line;
//            textDisplay.setText("");
...
//
//            QuickTestController.ALERT_AUDIOCLIP.setRate(1.0);
...
//        }
    ...
    void loadTest(){
        //new File("/home/uca/Desktop/typing-tutor-JavaFX/JavaProject/files/Test1.txt")
        ...
        try{
            ...
            String line;
            while((line = reader.readLine()) != null){
                textDisplay.setText( textDisplay.getText().trim() + line);
                arr += line;
            }
            reader.close();
            textDisplay.requestFocus();
    ...
    public void initialize(URL url, ResourceBundle rb) {
       //timeOption.getItems().addAll("1", "2", "3", "4");

        selectedFile = new ArrayList<>();
        selectedFile.add("*.doc");
        selectedFile.add("*.DOC");
        selectedFile.add("*.docx");
        selectedFile.add("*.DOCX");
        selectedFile.add("*.pdf");
        selectedFile.add("*.txt");
